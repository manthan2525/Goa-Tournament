      ...
      <AuthProvider>
        <SocketProvider>
          <Router>
            <CustomCursor />
            <DynamicBackground />
            <div className="relative z-10 flex flex-col min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 font-sans selection:bg-emerald-600 selection:text-white">
              {/* Top Navbar */}
              <Navbar />
