      ...
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-600">
            Join Goa's tournament network as a Player or Tournament Organizer.
          </p>
        </div>

        {/* Card */}
        <div className="rounded-3xl bg-white border border-slate-200 p-8 space-y-6 shadow-xl">
          {error && (
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-3.5 py-2.5 bg-white border border-slate-300 rounded-xl text-sm text-slate-900 placeholder-slate-400 focus:border-emerald-500"
                />
              </div>
            </div>
